...
To handle this on Receiver end, we can create a filter layer on receiver which will take care like done at [here](https://github.com/imYCGupta/cors-filter/tree/master/src/main/java/com/geekwise/cors/filter/CORSFilter.java).
